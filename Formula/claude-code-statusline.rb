...
class ClaudeCodeStatusline < Formula
  ...
  url "https://github.com/rz1989s/claude-code-statusline/archive/refs/tags/v2.26.4.tar.gz"
  sha256 "5cadb8b07e5a05280579b702c551587a9297266888db77f5c235b2a9344dfa4f"
  license "MIT"

...
class ClaudeCodeStatusline < Formula
  ...
  url "https://github.com/rz1989s/claude-code-statusline/archive/refs/tags/v2.24.7.tar.gz"
  sha256 "6f31ddd54587674f67804460bd3da2fe894c254892d9db493d1b48268e2a64c0"
  license "MIT"
